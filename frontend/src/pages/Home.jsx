...
import heroImg01 from "../assets/images/hero-img003.png";
          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                md:leading-[70px]">
                  Empowering Health, Extending Lives
                </h1>
                <p className='text_para' >
                Discover personalized healthcare solutions tailored to your unique needs.
                Join our community and take the first step towards a healthier future.
                </p>
        ...
        <div className="container">
          <div className="lg:w-[470px] mx-auto">
            <h2 className='heading text-center'>
              Leading the Way in Medical Services
            </h2>
            <p className='text_para text-center'>
              Offering world-class care for all,
               our health system delivers unparalleled,
               expert healthcare.
            </p>
          </div>
           ...
           mt-[30px] lg:mt-[55px]">
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                text-center'>
                  Our health system is dedicated
                   to providing world-class care for every patient,
                    ensuring exceptional healthcare services.
                </p>
                <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border 
                border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group 
      ...
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            ...
            <p className="text_para text-center">
              Experience world-class care for everyone at our health system,
               where we provide unparalleled expertise and exceptional healthcare services.
            </p>
          </div>
          <ServiceList />
        </div>
